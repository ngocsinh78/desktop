    ...
    , _filePath(std::move(conflictFilePath))
{
    ...
    _ui->descriptionLabel->setText(tr("The file \"%1\" dnsinh could not be synced because of a case clash conflict with an existing file on this system.").arg(_originalFileName));
